...
const SignupForm = () => {
  ...
  const { checkAuthUser } = useUserContext(); // context para user basado en AuthContext
  ...
  const { mutateAsync: signInAccount } = useSignInAccount();            // Mutación de Tanstack para crear una session en appwrite
